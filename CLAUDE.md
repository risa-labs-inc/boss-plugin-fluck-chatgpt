...
**ChatGPT (Dynamic)** (`ai.rever.boss.plugin.dynamic.fluck`) is a dynamic plugin for the BOSS desktop application.

ChatGPT integration for AI assistance

- **Plugin ID**: `ai.rever.boss.plugin.dynamic.fluck`
- **Main Class**: `ai.rever.boss.plugin.dynamic.fluck.FluckDynamicPlugin`
- **API Version**: 1.0.20
